...
*************************************
*/
#define WIFI_SSID        "xing nova 9"
#define WIFI_PASSWD      "zc231132"

#define MQTT_CLIENT_ID   "esp8266|securemode=2\\,signmethod=hmacsha1\\,timestamp=1704529492643|"   
#define MQTT_USER_NAME   "esp8266&k0m6nqH5ZyA"
#define MQTT_PASSWD      "DE43DE7EFF7E60B31734C2B178213A74525D701A"
#define BROKER_ASDDRESS  "k0m6nqH5ZyA.iot-as-mqtt.cn-shanghai.aliyuncs.com"
#define SUB_TOPIC        "/sys/k0m6nqH5ZyA/esp8266/thing/service/property/set"
#define PUB_TOPIC        "/sys/k0m6nqH5ZyA/esp8266/thing/event/property/post"
#define JSON_FORMAT      "{\\\"params\\\":{\\\"Latitude\\\":%d\\,\\\"Longitude\\\":%d\\,\\\"rocker\\\":%d\\}\\,\\\"version\\\":\\\"1.0.0\\\"}"
...
uint8_t esp8266_send_msg(void)	
{
  ...
  uint16_t count = 0;			
    ...
    //sprintf((char *)msg_buf,"AT+MQTTPUB=0,\""PUB_TOPIC"\",\""JSON_FORMAT"\",0,0\r\n",temp_value,humi_value);
		sprintf((char *)msg_buf,"AT+MQTTPUB=0,\""PUB_TOPIC"\",\""JSON_FORMAT"\",0,0\r\n",temp_value,humi_value,aodo_value,100-light_value/40);
